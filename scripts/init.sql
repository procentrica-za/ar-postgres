...
INSERT INTO public.Asset(ID, funclocID, name, description, serialNo, size, sizeUnit, type, class, dimension1val, dimension2val, dimension3val, dimension4val, dimension5val, dimension6val, extent, extentConfidence, derecognitionValue, takeondate,  CreatedDateTime, ModifiedDateTime)
VALUES ('d417af58-150b-4c13-945c-61129927e66b', '29add2e4-3593-4f6a-8260-3eb3297b216c', 'Synthetic surface', 'Synthetic surface', '1234' ,'1234', 'meters', '7cafb7b2-5a5f-4ce6-9185-3b4ba2441658', '4615f9f9-e0ea-4a88-8c2e-0f35a9cce024', '5', '1' , '2', '2.2', '6', '2', 'Fair', 'Very Good', '2000', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO public.Asset(ID, funclocID, name, description, serialNo, size, sizeUnit, type, class, dimension1val, dimension2val, dimension3val, dimension4val, dimension5val, dimension6val, extent, extentConfidence, derecognitionValue, takeondate, CreatedDateTime, ModifiedDateTime)
VALUES ('b5400743-ef94-46ae-ad66-50b0eb043f65', '29add2e4-3593-4f6a-8260-3eb3297b216c', 'Real surface', 'Synthetic surface', '1263' ,'1263', 'kilometers', '7cafb7b2-5a5f-4ce6-9185-3b4ba2441658', '4615f9f9-e0ea-4a88-8c2e-0f35a9cce024', '5', '1' , '2', '2.2', '6', '2', 'Poor', 'Very Good', '2000', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);